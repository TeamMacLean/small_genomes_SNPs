...
hm_r = 'hm <- rnorm(100, 4000, 200)' # Causative SNP at/near 10000
ht_r = 'ht <- runif(100, 1, 8000)'   # Genome length of 10000
...
puts "Is there a SNP at the centre of the distribution? -- #{snp_pos.include?(4000)}"

arabidopsis_c4 = ModelGenome::fasta_to_char_array("TAIR10_chr4.fasta")
small_genome = arabidopsis_c4[-8000..-1] # Genome length of 100 kb
