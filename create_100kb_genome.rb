...
hm_r = 'hm <- rnorm(1000, 50000, 5000)' # Causative SNP at/near 10000
ht_r = 'ht <- runif(1000, 1, 100000)'   # Genome length of 10000
...
small_genome = arabidopsis_c4[-100000..-1] # Genome length of 100 kb
