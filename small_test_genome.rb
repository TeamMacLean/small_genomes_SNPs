...
hm_r = 'hm <- rnorm(100, 40, 100)' # Causative SNP at/near 10000. Keep constant. 
ht_r = 'ht <- runif(100, 1, 80)'   # Genome length of 10000
...
small_genome = arabidopsis_c4[-100..-1] # Genome length of 100 kb
