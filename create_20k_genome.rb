...
hm_r = 'hm <- rnorm(200, 10000, 200)' # Causative SNP at/near 10000
ht_r = 'ht <- runif(200, 1, 20000)'   # Genome length of 8000
...
small_genome = arabidopsis_c4[-20000..-1] # Genome length of 8Kb

contig_size = 200 # 25-50 bp
