...
hm_r = 'hm <- rnorm(100, 10000, 200)' # Causative SNP at/near 10000
ht_r = 'ht <- runif(100, 1, 20000)'   # Genome length of 20000
...
small_genome = arabidopsis_c4[-20000..-1] # Genome length of 20 kb
